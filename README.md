...
[![Version](https://img.shields.io/badge/version-0.2.2-blue)](https://github.com/MrIbrahem/ArWikiCats/releases)
...
-   [13. أكواد غير مستخدمة حالياً](docs/Unused-Code.md)
-   [14. الخلاصة](#14-الخلاصة)
...
-   **نتائج دقيقة وموحدة** متوافقة مع أسلوب ويكيبيديا العربية.
...
print(f"المعير: {result.normalized}")
...
يغطي المشروع أكثر من **60,000 اختبار** منظمة في أربع فئات رئيسية:
...
-   استهلاك الذاكرة: حُسن الاستهلاك مقارنة [بالإصدار السابق](https://github.com/MrIbrahem/make2) **2GB إلى أقل من 100 ميجا**
...
الوظائف والفئات المصدرة الرئيسية:
